...
20 architecture `old` entries; shared criteria鈫抯core鈫抋ggregate kernel retained. Portfolio and pairwise operations remain separate nodes, not silently absorbed.
...
|---|---:|---|---|
| multi-criteria-ranking | 49 | numeric | Each dimension is scored independently (1鈥?) to avoid cross-contamination between dimensions. Weights are set by AHP (Analytic Hierarchy Process) or specified by the user. Final score = 危(dimension score 脳 dimension weight). |
| multi-criteria-ranking | 51 | numeric | **Sensitivity check**: perturb weights by 卤20%; if the ranking is unchanged the conclusion is robust; if the ranking flips it must be flagged as "weight-sensitive". |
| multi-criteria-ranking | 53 | textual | ## Budget Gate |
| multi-criteria-ranking | 57 | numeric | \\| S \\| 5鈥? \\| 鈮? dimensions \\| Optional \\| Ranking table + attack suggestions for top 2 gaps \\| |
| multi-criteria-ranking | 58 | numeric | \\| M \\| 9鈥?5 \\| 鈮? dimensions \\| Required \\| Ranking table + attack suggestions for top 3 gaps \\| |
| multi-criteria-ranking | 59 | numeric | \\| L \\| 16鈥?0 \\| 鈮? dimensions \\| Required (multi-weight scenarios) \\| Ranking table + attack suggestions for top 5 gaps + weight-sensitivity report \\| |
| evidence-based-prioritization | 51 | textual | ## Budget Gate |
| evidence-based-prioritization | 55 | numeric | \\| S \\| 3鈥? \\| all 6 dimensions \\| 鈮? supporting references per gap \\| ranking table + evidence-void report \\| |
| evidence-based-prioritization | 56 | numeric | \\| M \\| 9鈥?5 \\| all 6 dimensions \\| 鈮? supporting references per gap \\| ranking table + evidence-void report + attack suggestions for top 3 gaps \\| |
| evidence-based-prioritization | 57 | numeric | \\| L \\| 16鈥?0 \\| all 6 dimensions \\| 鈮? supporting references per gap \\| ranking table + detailed evidence map + attack suggestions for top 5 gaps \\| |
...
| stakeholder-weighted-ranking | 62 | numeric | \\| S \\| 5鈥?0 \\| 2鈥? classes \\| Simple average \\| Per-perspective rankings + consensus top-3 \\| |
| stakeholder-weighted-ranking | 63 | numeric | \\| M \\| 11鈥?0 \\| 3鈥? classes \\| Borda count \\| Per-perspective rankings + consensus top-5 + divergence analysis \\| |
...
| rapid-triage | 49 | numeric | **Round 2: light scoring (1鈥? points, two dimensions)** |
| rapid-triage | 51 | numeric | - Importance (1鈥?): a rough estimate of field impact |
| rapid-triage | 52 | numeric | - Feasibility (1鈥?): whether progress can be made within 6 months with existing resources |
...
| rapid-triage | 62 | numeric | \\| S \\| 50鈥?0 \\| 鈮?0% \\| top-15 \\| Candidate set + elimination-rationale summary \\| |
| rapid-triage | 63 | numeric | \\| M \\| 81鈥?50 \\| 鈮?0% \\| top-20 \\| Candidate set + elimination-rationale summary \\| |
| rapid-triage | 64 | numeric | \\| L \\| 150+ \\| 鈮?0% \\| top-30 \\| Candidate set + elimination-rationale summary + category statistics \\| |
| rapid-triage | 71 | numeric | 4. Call the `importance-scoring` SOP on the Keep set (1鈥? coarse score) |
| rapid-triage | 72 | numeric | 5. Call the `feasibility-scoring` SOP on the Keep set (1鈥? coarse score) |
| priority-sensitivity-testing | 28 | numeric | This tactic first establishes baseline weights (AHP or equal weights), then systematically perturbs the weights (卤20%), observes the ranking changes, and finally gives a stability verdict. |
| priority-sensitivity-testing | 35 | numeric | \\| weight-perturbation \\| Apply 卤20% perturbations to each dimension weight and recompute the ranking \\| Second step, systematic perturbation \\| |
...
| priority-sensitivity-testing | 47 | numeric | - Perturb only the highest-weight dimension (卤20%), producing 2 perturbation scenarios |
| priority-sensitivity-testing | 52 | numeric | - weight-perturbation expands the perturbation range to 卤30% and adds extreme scenarios (one dimension's weight set to 0) |
...
| best-option-selection | 21 | numeric | \\| Base SOP \\| Target \\| 卤10% Range \\| |
...
| full-ranking | 22 | numeric | \\| Base SOP \\| Target \\| 卤10% Range \\| |
...
| category-sorting | 22 | numeric | \\| Base SOP \\| Target \\| 卤10% Range \\| |
...
| non-compensatory-screening | 27 | numeric | \\| Base SOP \\| Target \\| 卤10% Range \\| |
...
| weight-elicitation | 23 | numeric | \\| Base SOP \\| Target \\| 卤10% Range \\| |
| weight-elicitation | 25 | numeric | \\| criterion-definition \\| 5-8 criteria \\| 4-9 \\| |
| weight-elicitation | 26 | numeric | \\| weight-elicitation-sop \\| 鈮? methods \\| 2-3 \\| |
...
| weight-elicitation | 76 | numeric | - AHP CR: [value] (< 0.1 鉁? |
