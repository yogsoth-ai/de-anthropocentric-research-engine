---
name: select-inventive-principle
description: "Select one or more inventive principles appropriate to a contradiction or transformation objective and state why each principle applies."
---
