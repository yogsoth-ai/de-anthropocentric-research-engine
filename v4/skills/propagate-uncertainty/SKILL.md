...
description: "Propagate input/parameter uncertainty through a model or reasoning chain to estimate output distributions, tail behavior, and uncertainty contributions."
---
