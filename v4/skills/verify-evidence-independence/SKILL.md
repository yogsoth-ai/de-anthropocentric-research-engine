---
name: verify-evidence-independence
description: "Seek independent evidence channels sufficient to determine whether a finding/gap is source-specific. No database/provider is named."
---
