...
Reject unfalsifiable wording, variables without operational definitions, and 鈥渃ompeting鈥?hypotheses with no observable divergence. Deductive mode is not applicable when no usable theory exists; abductive mode is not applicable without a clear anomaly.
...
| hypothesis-formulation | 62 | textual | \\| abductive-hypothesis-generation \\| An anomalous phenomenon that existing theory cannot explain has been observed \\| Anomaly 鈫?best explanation \\| |
| hypothesis-formulation | 68 | textual | ## Budget Gate |
| hypothesis-formulation | 72 | numeric | \\| S \\| 鈮? structured hypotheses \\| 鈮? relevant theories \\| 1 falsification scenario per hypothesis \\| Optional \\| |
| hypothesis-formulation | 73 | numeric | \\| M \\| 鈮? structured hypotheses \\| 鈮? theories + 鈮? mechanisms \\| 鈮? scenario + boundary conditions per hypothesis \\| 鈮? competing hypotheses \\| |
| hypothesis-formulation | 74 | numeric | \\| L \\| 鈮? structured hypotheses \\| 鈮? theories + 鈮? mechanisms \\| Complete falsifiability audit \\| 鈮? competing hypotheses + discriminating predictions \\| |
...
| hypothesis-formulation | 95 | numeric | 1. 鈮? complete structured hypotheses (including all 6 components) |
...
| deductive-hypothesis-generation | 52 | textual | - Theory citation that stays superficial (naming only, no specific propositions) 鈫?you must cite the theory's core propositions |
| deductive-hypothesis-generation | 53 | textual | - Skipping the mechanism and jumping straight from theory to prediction 鈫?the mechanism is the key node of the deductive chain and cannot be omitted |
| deductive-hypothesis-generation | 54 | textual | - Hypothesis scope too broad ("in all contexts") 鈫?deduction must state boundary conditions |
| deductive-hypothesis-generation | 56 | textual | ## Budget Gate |
| deductive-hypothesis-generation | 60 | numeric | \\| S \\| 鈮? named theories \\| 鈮? causal mechanisms \\| 鈮? structured hypotheses \\| 1 falsification scenario per hypothesis \\| |
| deductive-hypothesis-generation | 61 | numeric | \\| M \\| 鈮? named theories \\| 鈮? causal mechanisms \\| 鈮? structured hypotheses \\| 鈮? scenario + boundary conditions per hypothesis \\| |
| deductive-hypothesis-generation | 62 | numeric | \\| L \\| 鈮? named theories \\| 鈮? causal mechanisms \\| 鈮? structured hypotheses \\| full falsifiability audit + competing-theory comparison \\| |
...
| inductive-hypothesis-generation | 59 | numeric | \\| S \\| 鈮? independent observation patterns \\| 鈮? regularities \\| 鈮? structured hypotheses \\| Each hypothesis specifies its sample source \\| |
| inductive-hypothesis-generation | 60 | numeric | \\| M \\| 鈮? independent observation patterns \\| 鈮? regularities \\| 鈮? structured hypotheses \\| Generalization boundary + falsification scenario \\| |
| inductive-hypothesis-generation | 61 | numeric | \\| L \\| 鈮? independent observation patterns \\| 鈮? regularities \\| 鈮? structured hypotheses \\| Complete generalization boundary + comparison of competing regularities \\| |
...
| abductive-hypothesis-generation | 56 | numeric | \\| S \\| 1 precisely described anomaly \\| 鈮? candidate explanations \\| 1 best-explanation hypothesis \\| 鈮? competing hypothesis retained \\| |
| abductive-hypothesis-generation | 57 | numeric | \\| M \\| 1鈥? anomalies \\| 鈮? candidate explanations \\| 鈮? structured hypotheses \\| complete plausibility ranking \\| |
| abductive-hypothesis-generation | 58 | numeric | \\| L \\| 鈮? related anomalies \\| 鈮? candidate explanations \\| 鈮? structured hypotheses \\| complete ranking + discriminating prediction design \\| |
| hypothesis-operationalization | 50 | textual | - Circular definition (defining X in terms of X) 鈫?an operational definition must reference observable behavior or measurement |
| hypothesis-operationalization | 51 | textual | - Mismatch between measurement and construct (operationalism gap) 鈫?must argue that the measurement instrument actually captures the construct |
| hypothesis-operationalization | 52 | textual | - Overly broad boundary conditions ("in all contexts") 鈫?must be specific about sample, context, and time range |
...
| hypothesis-operationalization | 59 | numeric | \\| M \\| Above + justification of operationalization validity \\| Variable measurement includes reliability/validity considerations \\| Complete boundary conditions \\| 鈮? falsification scenarios \\| |
...
| theory-mechanism-extraction | 45 | numeric | - Coverage: 1 theory, 鈮? mechanism, 鈮? hypothesis candidate |
| theory-mechanism-extraction | 48 | numeric | **Standard (M tier, 2-3 theories)** |
| theory-mechanism-extraction | 50 | numeric | - Coverage: 鈮? theories, 鈮? mechanisms, 鈮? hypothesis candidate per mechanism |
...
| theory-mechanism-extraction | 53 | numeric | **Deep (L tier, 鈮? theories)** |
| theory-mechanism-extraction | 55 | numeric | - Coverage: 鈮? theories, 鈮? mechanisms, cross-theory variable mapping, 鈮? hypothesis candidates |
| theory-mechanism-extraction | 58 | textual | ## Minimum Yield |
| theory-mechanism-extraction | 60 | numeric | - 鈮? theories identified and described (including core claim and scope of applicability) |
| theory-mechanism-extraction | 61 | numeric | - 鈮? mechanisms extracted from the theories (each with a causal-chain description) |
| theory-mechanism-extraction | 62 | numeric | - Each mechanism corresponds to at least 1 hypothesis candidate, including: |
| anomaly-driven-abduction | 22 | textual | Inductive/abductive path 鈥?precisely describe anomalous phenomena that existing theory cannot explain, generate multiple candidate explanations, rank by plausibility, and provide a structured basis for abductive hypotheses. |
...
| anomaly-driven-abduction | 41 | numeric | - Sequential execution: anomaly-characterization 鈫?explanation-generation (鈮? explanations) 鈫?plausibility-ranking |
| anomaly-driven-abduction | 44 | numeric | **Standard (M tier, 1-3 related anomalies)** |
| anomaly-driven-abduction | 45 | numeric | - anomaly-characterization executes independently for each anomaly; explanation-generation generates 鈮? explanations (explanations may be shared across anomalies); plausibility-ranking ranks all explanations uniformly |
...
| anomaly-driven-abduction | 55 | numeric | - 鈮? candidate explanations, each explanation: |
...
| competing-hypothesis-construction | 55 | numeric | \\| S \\| 鈮? genuinely competing hypotheses \\| 鈮? discriminating prediction \\| simplified version (2脳2) \\| 1 falsification scenario per hypothesis \\| |
| competing-hypothesis-construction | 56 | numeric | \\| M \\| 鈮? competing hypotheses \\| 鈮? discriminating predictions \\| full matrix (hypotheses 脳 predictions) \\| full falsification per hypothesis \\| |
| competing-hypothesis-construction | 57 | numeric | \\| L \\| 鈮? competing hypotheses \\| 鈮? discriminating predictions \\| full matrix + experiment design suggestions \\| full falsifiability audit \\| |
...
| competing-hypothesis-matrix | 34 | numeric | \\| competing-hypothesis-generation \\| Based on the primary hypothesis, generate 鈮? alternative hypotheses competing with it (different mechanisms, same or similar phenomenon prediction range) \\| Required in all modes, execute first \\| |
| competing-hypothesis-matrix | 35 | textual | \\| discriminating-prediction-design \\| Design discriminating predictions for each pair of competing hypotheses 鈥?find an observable result for which the two hypotheses predict differently \\| Required in all modes, after competing-hypothesis-generation \\| |
...
| competing-hypothesis-matrix | 41 | numeric | - Sequentially execute all 3 SOPs; generate 鈮? competing hypotheses; design 鈮? discriminating predictions; build comparison matrix |
...
| competing-hypothesis-matrix | 54 | numeric | - 鈮? competing hypotheses (explaining the same phenomenon as the primary hypothesis but with different mechanisms) |
| competing-hypothesis-matrix | 55 | numeric | - 鈮? discriminating predictions (each prediction produces different expected outcomes for at least 2 hypotheses) |
