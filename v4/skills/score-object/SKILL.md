---
name: score-object
description: "Score a typed object against an explicit rubric with evidence, uncertainty, and rationale. The parent tactic supplies the object schema and rubric (candidate, gap, claim, obstacle, etc.)."
---
