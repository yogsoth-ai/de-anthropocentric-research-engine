...
```yaml
required: [resource_demand, resource_supply, plan_scope]
...
```yaml
produces: [quantify_resource_gap_result, evidence_trace, uncertainties]
...
- intermediate: experiment-execution/resource-quantification
