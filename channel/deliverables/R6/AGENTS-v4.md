...
2. Resolve the DARE v4 skill root from the first existing path:
   ...
   DARE v4 replaces v3. Do not combine it with or fall back to a v3 skill root.
3. Read `<skill-root>/dare-v4/SKILL.md` first.
4. Read `<skill-root>/research-catalog-v4/SKILL.md` before selecting research tactics.
