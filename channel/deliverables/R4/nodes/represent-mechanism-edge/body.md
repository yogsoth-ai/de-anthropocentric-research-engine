...
Represent a directed mechanism edge with pathway, sign/direction, assumptions, falsifier, strength, and evidence provenance.
...
- concept: knowledge-structuring-mechanism-edge-creation <- knowledge-structuring/mechanism-edge-creation
- concept: knowledge-structuring-mechanism-mapping (edge core) <- knowledge-structuring/mechanism-mapping (edge core)
