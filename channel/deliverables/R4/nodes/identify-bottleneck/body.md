...
- concept: convergence-bottleneck-identification <- convergence/bottleneck-identification
- concept: deep-insight-critical-path-identification (limiting-input interpretation) <- deep-insight/critical-path-identification (limiting-input interpretation)
