...
Update confidence in a concept, relation, claim, or model component from new supporting/contradicting evidence with explicit rationale.
...
- concept: knowledge-structuring-confidence-update <- knowledge-structuring/confidence-update
- concept: knowledge-structuring-confidence-scoring <- knowledge-structuring/confidence-scoring
