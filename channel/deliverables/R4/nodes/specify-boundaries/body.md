...
State applicability assumptions, scope, and known boundary conditions.
...
- concept: hypothesis-formation-boundary-condition-specification <- hypothesis-formation/boundary-condition-specification
- concept: stress-test-claim-refinement (scope narrowing portion) <- stress-test/claim-refinement (scope narrowing portion)
