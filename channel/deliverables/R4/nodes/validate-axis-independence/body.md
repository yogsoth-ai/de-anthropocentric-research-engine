...
Test candidate dimensions pairwise for independence/redundancy; merge covarying axes and remove non-informative axes.
...
- concept: knowledge-structuring-axis-validation <- knowledge-structuring/axis-validation
