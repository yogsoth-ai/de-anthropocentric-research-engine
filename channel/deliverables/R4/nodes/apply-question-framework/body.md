...
- concept: hypothesis-formation-framework-matching <- hypothesis-formation/framework-matching
- concept: hypothesis-formation-pico-application <- hypothesis-formation/pico-application
- concept: hypothesis-formation-spider-application <- hypothesis-formation/spider-application
- concept: hypothesis-formation-spice-application <- hypothesis-formation/spice-application
- concept: hypothesis-formation-eclipse-application <- hypothesis-formation/eclipse-application
