...
- concept: knowledge-structuring-concept-extraction (core) <- knowledge-structuring/concept-extraction (core)
- concept: knowledge-structuring-seed-concept-search (semantic core) <- knowledge-structuring/seed-concept-search (semantic core)
