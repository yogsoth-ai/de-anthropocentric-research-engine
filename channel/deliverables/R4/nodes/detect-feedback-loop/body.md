...
- concept: knowledge-structuring-feedback-loop-detection <- knowledge-structuring/feedback-loop-detection
- concept: knowledge-structuring-loop-documentation (semantic core) <- knowledge-structuring/loop-documentation (semantic core)
