...
- concept: hypothesis-formation-consistency-check <- hypothesis-formation/consistency-check
- concept: convergence-rank-comparison (coherence portion) <- convergence/rank-comparison (coherence portion)
