...
Define ontology/model scope, inclusion boundaries, granularity, and intended use before structural extraction.
...
- concept: knowledge-structuring-domain-scoping <- knowledge-structuring/domain-scoping
