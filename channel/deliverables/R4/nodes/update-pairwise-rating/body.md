...
Update candidate latent ratings and uncertainty from sequential pairwise outcomes using an explicitly chosen Bradley-Terry/Elo/Glicko/TrueSkill-style update model.
...
- concept: convergence-dynamic-tracking <- convergence/dynamic-tracking [strategy]
