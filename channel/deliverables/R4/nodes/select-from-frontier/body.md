...
Select a preferred frontier point/portfolio and state the sacrificed alternatives/tradeoffs.
...
- concept: convergence-selection-from-frontier <- convergence/selection-from-frontier
