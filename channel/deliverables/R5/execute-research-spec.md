...
3. Load only the context and state slice required by that item. Load the selected tactic; the tactic body controls its required SOP calls and scientific thresholds.
