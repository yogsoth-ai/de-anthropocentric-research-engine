---
name: validate-mitigation-effect
description: "Re-run the relevant failure/adversarial test after a mitigation and verify that risk actually decreases without unacceptable new failure modes."
---
