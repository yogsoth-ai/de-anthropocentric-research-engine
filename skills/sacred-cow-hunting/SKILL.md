...
Find and challenge domain's unquestioned beliefs.
...
| Tactic | Role |
|--------|------|
| assumption-enumeration | Surface paradigmatic assumptions (sacred cows) |
| inversion-protocol | Reverse sacred cows → build alternatives |
...
| assumption-perturbation | Test consequences of violating sacred cows |
| benchmark-challenge | Challenge formalized sacred cows (standards) |
| reversal-generation | Generate formal negations of sacred cows |
| constructive-rebellion | Build alternatives that productively violate dogma |
| destruction-synthesis | Synthesize sacred cow hunting outputs |

## Execution Guidance

1. **Map the domain**: Identify the domain's core beliefs, rules, and "everyone knows" statements
2. **Hunt sacred cows**: Use sacred-cow-identification to find unquestioned beliefs
3. **Validate sacredness**: Confirm these are truly unquestioned (not just best practice)
4. **Research heretics**: Search for cases where violating these beliefs succeeded
5. **Perturb**: Use assumption-perturbation to model consequences of violation
