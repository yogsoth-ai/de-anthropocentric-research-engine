---
name: downgrade-equivalence-claim
description: "When full equivalence fails, downgrade to the strongest defensible relation (e.g. substructure, homomorphism, shared invariant, analogy) and record exactly what ceased to be preserved."
---
