...
Identify and suspend fundamental assumptions via de Bono PO.
...
| Tactic | Role |
|--------|------|
| provocation-generation | Generate PO provocations from negated axioms |
| assumption-enumeration | Surface assumptions to negate |

## Available SOPs

| SOP | Role |
|-----|------|
| assumption-perturbation | Perturb each axiom and observe consequences |
| reversal-generation | Generate formal negations of axioms |
| constructive-rebellion | Build alternatives from negated axioms |
| destruction-synthesis | Synthesize negation outputs |

## Execution Guidance

1. **Surface axioms**: Use assumption-enumeration tactic to identify paradigmatic assumptions
2. **Apply PO**: For each axiom, state "PO: [negation]" — suspend judgment
3. **Perturb**: Run assumption-perturbation to observe system response under negation
