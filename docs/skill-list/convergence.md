...
Used to evaluate, rank, converge on, and optimize across multiple options, viewpoints, or candidate directions, helping turn a large choice set into an executable decision.
