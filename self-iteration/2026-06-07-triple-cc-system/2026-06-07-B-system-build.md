...
**Tech Stack:** Python 3.11 + pytest (pure functions, sub-second) · real claude/codex (integration e2e) · skill-creator conventions (`scripts/` executable + `references/` read on demand) · third-party proxy `<PROXY_HOST>`.
