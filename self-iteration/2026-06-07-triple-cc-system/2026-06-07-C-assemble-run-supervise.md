...
**Tech Stack:** All of B's components (three weights + 9 leaves + 2 loss skill + optimization-loop skill) · tmux long-running optimizer · real claude/codex · `/compact` cross-batch state recovery · third-party proxy `<PROXY_HOST>`.
